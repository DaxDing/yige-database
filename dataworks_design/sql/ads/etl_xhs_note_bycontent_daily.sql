...
SELECT /*+ MAPJOIN(attr) */
    ...
    -- ============ 金额指标 ============
    CAST((COALESCE(e.pgy_actual_amt, 0) - COALESCE(s.pgy_actual_amt, 0))
        + (COALESCE(ce.fee, 0) - COALESCE(cs.fee, 0)) AS DECIMAL(20,6))              AS fee,
    CAST(COALESCE(ce.fee, 0) - COALESCE(cs.fee, 0) AS DECIMAL(20,6))                 AS ad_fee,
    ...
    CAST(CASE WHEN (COALESCE(e.impression, 0) - COALESCE(s.impression, 0)) > 0
         THEN ((COALESCE(e.pgy_actual_amt, 0) - COALESCE(s.pgy_actual_amt, 0)) + (COALESCE(ce.fee, 0) - COALESCE(cs.fee, 0))) * 1000.0 / (COALESCE(e.impression, 0) - COALESCE(s.impression, 0))
         ELSE 0 END AS DECIMAL(20,6))                                             AS cpm,
    -- CPE
    CAST(CASE WHEN (COALESCE(e.interaction, 0) - COALESCE(s.interaction, 0)) > 0
         THEN ((COALESCE(e.pgy_actual_amt, 0) - COALESCE(s.pgy_actual_amt, 0)) + (COALESCE(ce.fee, 0) - COALESCE(cs.fee, 0))) * 1.0 / (COALESCE(e.interaction, 0) - COALESCE(s.interaction, 0))
         ELSE 0 END AS DECIMAL(20,6))                                             AS cpe,
    -- CPC
    CAST(CASE WHEN (COALESCE(e.click, 0) - COALESCE(s.click, 0)) > 0
         THEN ((COALESCE(e.pgy_actual_amt, 0) - COALESCE(s.pgy_actual_amt, 0)) + (COALESCE(ce.fee, 0) - COALESCE(cs.fee, 0))) * 1.0 / (COALESCE(e.click, 0) - COALESCE(s.click, 0))
    ...
    CAST(CASE WHEN attr.attribution_period = '15' AND (COALESCE(e.15d_enter_shop_uv, 0) - COALESCE(s.15d_enter_shop_uv, 0)) > 0
         THEN ((COALESCE(e.pgy_actual_amt, 0) - COALESCE(s.pgy_actual_amt, 0)) + (COALESCE(ce.fee, 0) - COALESCE(cs.fee, 0))) * 1.0 / (COALESCE(e.15d_enter_shop_uv, 0) - COALESCE(s.15d_enter_shop_uv, 0))
         WHEN attr.attribution_period = '30' AND (COALESCE(e.30d_enter_shop_uv, 0) - COALESCE(s.30d_enter_shop_uv, 0)) > 0
         THEN ((COALESCE(e.pgy_actual_amt, 0) - COALESCE(s.pgy_actual_amt, 0)) + (COALESCE(ce.fee, 0) - COALESCE(cs.fee, 0))) * 1.0 / (COALESCE(e.30d_enter_shop_uv, 0) - COALESCE(s.30d_enter_shop_uv, 0))
    ...
    CAST(CASE WHEN attr.attribution_period = '15' AND (COALESCE(e.15d_shop_new_customer_uv, 0) - COALESCE(s.15d_shop_new_customer_uv, 0)) > 0
         THEN ((COALESCE(e.pgy_actual_amt, 0) - COALESCE(s.pgy_actual_amt, 0)) + (COALESCE(ce.fee, 0) - COALESCE(cs.fee, 0))) * 1.0 / (COALESCE(e.15d_shop_new_customer_uv, 0) - COALESCE(s.15d_shop_new_customer_uv, 0))
         WHEN attr.attribution_period = '30' AND (COALESCE(e.30d_shop_new_customer_uv, 0) - COALESCE(s.30d_shop_new_customer_uv, 0)) > 0
         THEN ((COALESCE(e.pgy_actual_amt, 0) - COALESCE(s.pgy_actual_amt, 0)) + (COALESCE(ce.fee, 0) - COALESCE(cs.fee, 0))) * 1.0 / (COALESCE(e.30d_shop_new_customer_uv, 0) - COALESCE(s.30d_shop_new_customer_uv, 0))
         ELSE 0 END AS DECIMAL(20,6))                                             AS cac,
    -- 全店ROI
    CAST(CASE WHEN ((COALESCE(e.pgy_actual_amt, 0) - COALESCE(s.pgy_actual_amt, 0)) + (COALESCE(ce.fee, 0) - COALESCE(cs.fee, 0))) > 0
         THEN CASE WHEN attr.attribution_period = '15' THEN (COALESCE(e.15d_shop_order_gmv, 0) - COALESCE(s.15d_shop_order_gmv, 0)) * 1.0 / ((COALESCE(e.pgy_actual_amt, 0) - COALESCE(s.pgy_actual_amt, 0)) + (COALESCE(ce.fee, 0) - COALESCE(cs.fee, 0)))
                   ELSE (COALESCE(e.30d_shop_order_gmv, 0) - COALESCE(s.30d_shop_order_gmv, 0)) * 1.0 / ((COALESCE(e.pgy_actual_amt, 0) - COALESCE(s.pgy_actual_amt, 0)) + (COALESCE(ce.fee, 0) - COALESCE(cs.fee, 0))) END
         ELSE 0 END AS DECIMAL(20,6))                                              AS roi,
    -- 单品ROI
    CAST(CASE WHEN ((COALESCE(e.pgy_actual_amt, 0) - COALESCE(s.pgy_actual_amt, 0)) + (COALESCE(ce.fee, 0) - COALESCE(cs.fee, 0))) > 0
         THEN CASE WHEN attr.attribution_period = '15' THEN (COALESCE(e.15d_task_product_gmv, 0) - COALESCE(s.15d_task_product_gmv, 0)) * 1.0 / ((COALESCE(e.pgy_actual_amt, 0) - COALESCE(s.pgy_actual_amt, 0)) + (COALESCE(ce.fee, 0) - COALESCE(cs.fee, 0)))
                   ELSE (COALESCE(e.30d_task_product_gmv, 0) - COALESCE(s.30d_task_product_gmv, 0)) * 1.0 / ((COALESCE(e.pgy_actual_amt, 0) - COALESCE(s.pgy_actual_amt, 0)) + (COALESCE(ce.fee, 0) - COALESCE(cs.fee, 0))) END
