-- ============================================================
-- 补充 ODS 层 keyword_id、dt、etl_time，清理 raw_data 零值键
-- 源表/目标表: ods_xhs_keyword_realtime_hi
-- 上游依赖: sync_xhs_keyword_realtime_hi
-- 下游依赖: etl_dwd_xhs_keyword_realtime_hi
-- 调度参数: bizdate
-- ============================================================
